...
const App = () => {
  ...
  return (
    <AmplifyAuthenticator>
      <AmplifySignIn
        headerText='BigLog Inc. Team, Sign-In with Your E-Mail Address'
        slot='sign-in'
      />
      <AmplifySignUp
        headerText='BigLog Inc. Team, Sign-Up with Your Valid E-Mail Address'
        slot='sign-up'
      />
      <div className='header'>
        <h2>
          <a href='/'>BigLog Inc. Team Uploader</a>
        </h2>
      </div>
